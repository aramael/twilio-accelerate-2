"""
Django settings for twilio_accelerate_workshop project.
...
ROOT_URLCONF = 'twilio_accelerate_workshop.urls'
...
WSGI_APPLICATION = 'twilio_accelerate_workshop.wsgi.application'
